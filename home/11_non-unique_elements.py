"""
f you have 50 different plug types, appliances wouldn't be available and would be very expensive.
...
solving more complex tasks. The concept can be easily generalized for real world tasks.
